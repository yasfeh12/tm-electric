        ...
        <div className="carousel-inner">
          ...
          <div className="carousel-item active position-relative">
            <img
              ...
              alt="Electrician performing 24/7 emergency service"
              style={{
                height: window.innerWidth < 576 ? "400px" : "600px",
                objectFit: "cover",
              }}
            />
            <div
            ...
            >
              <h2
                style={{
                  fontSize: window.innerWidth < 576 ? "1.5rem" : "3rem",
                  fontWeight: "bold",
                  color: "#ffffff",
                }}
              >
              ...
              <p
                style={{
                  fontSize: window.innerWidth < 576 ? "1rem" : "1.5rem",
                  color: "#ffffff",
                }}
              >
                We are available for emergency electrical repairs , anywhere,
                anyhow!
              </p>
              <a
                ...
                style={{
                  fontSize: window.innerWidth < 576 ? "0.9rem" : "1.2rem",
                  fontWeight: "bold",
                }}
              >
                WhatsApp Us
          ...
          <div className="carousel-item position-relative">
            <img
              ...
              className="d-block w-100"
              alt="Electrician performing electrical installations"
              style={{
                height: window.innerWidth < 576 ? "400px" : "600px",
                objectFit: "cover",
              }}
          ...
          <div className="carousel-item position-relative">
            <img
              ...
              className="d-block w-100"
              alt="Electrician installing a fuse box"
              style={{
                height: window.innerWidth < 576 ? "400px" : "600px",
                objectFit: "cover",
              }}
